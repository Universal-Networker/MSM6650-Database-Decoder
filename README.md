...
This tool is able to decode the audio databases EPROM binaries used for the OKI MSM6650 however it was more specifically created to decode the announcements on a British Rail Class 365 announcement unit.
